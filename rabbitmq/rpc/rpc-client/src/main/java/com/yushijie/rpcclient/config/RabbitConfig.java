package com.yushijie.rpcclient.config;
...
public class RabbitConfig {
    ...
    public static final String RPC_ROUTING = "rpc.routing";
...
//        rabbitTemplate.(FAKE_QUEUE);
        rabbitTemplate.setReplyTimeout(5000);
        return rabbitTemplate;
    }
//    //返回队列监听器（必须有）
//    @Bean(name="replyMessageListenerContainer")
//    public SimpleMessageListenerContainer createReplyListenerContainer(ConnectionFactory connectionFactory, RabbitTemplate rabbitTemplate) {
...
//    }
    ...
    public Binding rpcBinding() {
        return BindingBuilder.bind(rpcQueue()).to(directExchange()).with(RPC_ROUTING);
    }

/*    @Bean
    public Binding topicBinding1() {
        return BindingBuilder.bind(rpcQueue()).to().with(FAKE_QUEUE);
    }*/
